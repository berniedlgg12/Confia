      ...
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-lg leading-8 text-primary-foreground">
            Combinamos el respaldo de la aseguradora líder, <Link href="https://aserta.com.es" target="_blank" rel="noopener noreferrer" className="font-bold" style={{color: '#E10600'}}>Aserta</Link>, con un servicio de mediación cercano y experto para ofrecerte la mejor solución en seguros de caución.
          </p>
        </div>
